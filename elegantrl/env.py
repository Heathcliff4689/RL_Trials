...
class PreprocessEnv():  # environment wrapper # todo 2021-03-17
    def __init__(self, env, if_print=True, data_type=np.float32):
        ...
        (self.env_name, self.state_dim, self.action_dim, self.action_max, self.max_step,
         self.if_discrete, self.target_reward
         ) = (env.env_name, env.state_dim, env.action_dim, env.action_max, env.max_step,
              env.if_discrete, env.target_reward)
