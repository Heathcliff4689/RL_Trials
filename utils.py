...
def computeInterference(f_bb, F_rf, group, power, start_index=0, P_tol=args.P_tol):  # haven't been tested
    """
    :param f_bb:
    :param F_rf:
...
def computeSINR(group_order, user_order, F_rf, Pw, groups_dict, sigma=args.sigma):
